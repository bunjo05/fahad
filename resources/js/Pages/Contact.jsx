                ...
                <section className="bg-black py-28 text-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <p className="mx-auto max-w-3xl text-lg text-gray-300">
                            ...
                            corporate event, family portrait, or personal
                            photoshoot, we'd love to hear your story.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="grid gap-16 lg:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p className="mb-8 text-gray-600">
                                    ...
                                    needs, and we'll get back to you as soon as
                                    possible.
                                </p>
                            ...
                            <div>
                                ...
                                <p className="mb-10 text-gray-600">
                                    We'd love to discuss your photography needs
                ...
                <section className="bg-black py-24 text-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <p className="mx-auto mb-8 max-w-2xl text-gray-300">
                            Let's capture your special moments and create
