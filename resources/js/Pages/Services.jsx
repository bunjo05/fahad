                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="mx-auto mb-16 max-w-2xl text-gray-600">
                            ...
                            passion for storytelling to deliver exceptional
                ...
                <div className="container mx-auto px-6">
                    ...
                    >
                        ...
                        <p className="mx-auto max-w-2xl text-gray-600">
                            A simple and professional workflow designed to make
                            your photography experience stress-free.
                        </p>
                    </motion.div>
            ...
            <section className="bg-black py-24 text-white">
                ...
                >
                    ...
                    <p className="mx-auto mb-8 max-w-2xl text-gray-300">
                        Let's create beautiful images that you'll treasure for a
                        lifetime. Contact us today to discuss your photography
                        needs.
                    </p>
                    <motion.button
                        type="button"
