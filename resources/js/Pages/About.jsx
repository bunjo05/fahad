            ...
            <GuestLayout>
                ...
                <section className="relative bg-black py-32 text-white">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        >
                            We capture authentic emotions, unforgettable
                            moments, and timeless memories through professional
                            photography.
                        </motion.p>
                    </div>
                </section>
                        ...
                        <div className="grid items-center gap-16 lg:grid-cols-2">
                            ...
                            >
                                ...
                                <p className="mb-5 leading-relaxed text-gray-600">
                                    Photography is more than taking pictures—it
                                    is preserving moments that can never be
                                    recreated. Our journey began with a passion
                                    for storytelling and a desire to capture
                                    genuine emotions through beautiful imagery.
                                </p>
                                ...
                                <p className="mb-5 leading-relaxed text-gray-600">
                                    ...
                                    special occasions. Every client and every
                                    story is unique, which is why we approach
                                    every shoot with creativity, care, and
                                    attention to detail.
                                </p>

                                <p className="leading-relaxed text-gray-600">
                                    Our mission is simple: create timeless
                                    photographs that allow you to relive your
                                    most meaningful memories for years to come.
                                </p>
                            </motion.div>
                        </div>
                    </div>
